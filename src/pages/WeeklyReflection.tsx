  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-purple-50 to-pink-50">
      <div className="container mx-auto px-4 py-6 max-w-4xl">
        ...
        {canSaveThisWeek ? (
          <Card className="mb-8 bg-white border border-purple-200 shadow-lg">
            <CardHeader>
          ...
          <Card className="mb-8 bg-green-50 border border-green-200">
            <CardContent className="p-6 text-center">
              <div className="text-green-600 mb-4">
                ...
                <h3 className="text-xl font-bold">Refleksi Minggu Ini Sudah Selesai! ✅</h3>
                <p>Kamu sudah melakukan refleksi untuk minggu ini. Kembali lagi Minggu depan!</p>
              </div>
            </CardContent>
          </Card>
        )}
        ...
        <div className="space-y-4">
          <h2 className="text-2xl font-bold text-purple-700 mb-4">📖 Riwayat Refleksi</h2>
            ...
            reflections.map((reflection) => (
              <Card key={reflection.id} className="bg-white border border-purple-200 shadow-md">
                ...
                <CardContent className="space-y-3">
                  <div>
                    <h4 className="font-semibold text-red-600 text-sm">❌ Kesalahan Terbesar:</h4>
                  ...
                  <div>
                    <h4 className="font-semibold text-orange-600 text-sm">😤 Emosi Dominan:</h4>
                  ...
                  <div>
                    <h4 className="font-semibold text-blue-600 text-sm">💡 Pelajaran Utama:</h4>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div>
                      <h4 className="font-semibold text-red-600 text-sm">🚫 Habit Buruk:</h4>
                      <p className="text-sm text-gray-700 bg-red-50 p-2 rounded border border-red-200">
                    ...
                    <div>
                      <h4 className="font-semibold text-green-600 text-sm">✅ Habit Bagus:</h4>
        ...
        {/* Tips Section */}
        <Card className="mt-8 bg-gradient-to-r from-amber-50 to-yellow-50 border border-amber-200">
          <CardHeader>
            <CardTitle className="text-amber-700">💡 Tips Ekstra</CardTitle>
          </CardHeader>
          <CardContent>
